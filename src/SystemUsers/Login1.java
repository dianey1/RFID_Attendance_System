...
import rfid_attendance_system.MainInterface;
...
public class Login1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RFID Based Attendance System");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (authenticateUser()){
            status.setUser(jTextField1.getText());
    ...
    private boolean authenticateUser(){
        ...
        login.query("select password from administrator where username='" +username+ "'");
        ResultSet passwd = login.getResultSet();

         try{
            
            while(passwd.next())
            {
                pwd1 = passwd.getString(1);
                System.out.println(passwd.getString(1));
            }
            
            if (pwd1.equals(pwd) && pwd.length() != 0){
